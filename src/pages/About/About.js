    ...
    <div className="max-w-container mx-auto px-4">
      ...
      <div className="pb-10">
       ...
       is one of the world's leading ecommerce brands and is internationally
        ...
        <Link to="/shop">
          <button className={`${isDarkMode?'bg-orange-200 text-black':'text-white'} w-52 h-10 bg-primeColor  bg-black flex justify-center items-center text-base font-semibold hover:bg-yellow-600 duration-300 cursor-pointer`}>
            Continue Shopping
          </button>
        </Link>
      </div>
